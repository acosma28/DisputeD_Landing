                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-10">
                                <div className="row align-items-center">
                                    <div className="col-md-5 col-sm-12 mb-30 text-center text-md-start"><img src="assets/imgs/page/404/404.png" alt="DisputeDine" /></div>
                ...
                <div className="section bg-grey-80 pt-70 pb-70">
                    <div className="container">
                        <ul className="list-partners">
                            <li><img src="assets/imgs/page/homepage1/placed.png" alt="DisputeDine" /></li>
                            <li><img src="assets/imgs/page/homepage1/cuebiq.png" alt="DisputeDine" /></li>
                            <li><img src="assets/imgs/page/homepage1/factual.png" alt="DisputeDine" /></li>
                            <li><img src="assets/imgs/page/homepage1/placeiq.png" alt="DisputeDine" /></li>
                            <li><img src="assets/imgs/page/homepage1/airmeet.png" alt="DisputeDine" /></li>
                            <li><img src="assets/imgs/page/homepage1/spen.png" alt="DisputeDine" /></li>
                            <li><img src="assets/imgs/page/homepage1/klippa.png" alt="DisputeDine" /></li>
                            <li><img src="assets/imgs/page/homepage1/matrix.png" alt="DisputeDine" /></li>
                        </ul>
                    </div>
                </div>
