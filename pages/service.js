...
const pageServices = () => {
    ...
    return (
        <>
            <Head>
                <title>Dispute Dine Our Services</title>
            </Head>
                ...
                <section className="section banner-service bg-grey-60 position-relative">
                            ...
                            <div className="row align-items-center">
                                <div className="col-xxl-6 col-xl-7 col-lg-12">
                                    <div className="box-banner-service">
                                        <h1 className="color-brand-1 mb-20">Cutting-edge <br className="d-none d-xxl-block" />solutions to secure your deliveries</h1>
                                        <div className="row">
                    ...
                    <div className="row m-0">
                        ...
                        <div className="col-xxl-7 col-xl-5 col-lg-6 pr-0">
                            <div className="d-none d-xxl-block pl-70"><img className="w-100 d-block" src="assets/imgs/page/service/banner.png" alt="DisputeDine" /></div>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="box-business-rd">
                            <div className="row align-items-center">
                                <div className="col-lg-5"><span className="btn btn-tag">Business</span>
                                    ...
                                    <div className="mt-50 text-start"> <Link className="btn btn-brand-1 hover-up" href="#">Go to App </Link><Link className="btn btn-default font-sm-bold hover-up" href="#">Learn More
                                        <svg className="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                                        </svg></Link></div>
                                </div>
                                <div className="col-lg-7">
                                    <div className="box-business-service">
                                        ...
                                        <div className="box-image-1 shape-3"> <img src="assets/imgs/page/service/img1.png" alt="DisputeDine" /></div>
                                        <div className="box-image-2 shape-2"> <img src="assets/imgs/page/service/img2.png" alt="DisputeDine" /></div>
                                        <div className="box-image-3 shape-1"> <img src="assets/imgs/page/service/img4.png" alt="DisputeDine" />
                                            <div className="cardNumber bg-white">
                        ...
                        <div className="row mt-55">
                            <div className="col-xl-3 col-lg-6 col-md-6">
                                <div className="card-blog-grid card-blog-grid-2 hover-up">
                                    <div className="card-image"><Link href="blog-detail"><img src="assets/imgs/page/homepage2/news1.png" alt="DisputeDine" /></Link></div>
                            ...
                            <div className="col-xl-3 col-lg-6 col-md-6">
                                <div className="card-blog-grid card-blog-grid-2 hover-up">
                                    <div className="card-image"><Link href="blog-detail"><img src="assets/imgs/page/homepage2/news2.png" alt="DisputeDine" /></Link></div>
                                    <div className="card-info"><Link href="blog-detail">
                            ...
                            <div className="col-xl-3 col-lg-6 col-md-6">
                                <div className="card-blog-grid card-blog-grid-2 hover-up">
                                    <div className="card-image"><Link href="blog-detail"><img src="assets/imgs/page/homepage2/news3.png" alt="DisputeDine" /></Link></div>
                                    <div className="card-info"><Link href="blog-detail">
