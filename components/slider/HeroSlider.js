                                ...
                                <div className="row">
                                    <div className="col-xl-5 col-lg-6 col-md-8 col-sm-10 col-12">
                                        <div className="box-info-banner11">
                                            ...
                                            <div className="mt-30 d-flex"><img className="w-50 mr-10" src="assets/imgs/template/appstore.png" alt="DisputeDine" /><img className="w-50" src="assets/imgs/template/google-play.png" alt="DisputeDine" /></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
