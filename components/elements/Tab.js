            ...
            <div className="tab-content">
                    ...
                    <div className="box-tab-32">
                        <div className="row align-items-center">
                            <div className="col-xl-6 col-lg-5">
                                <img className="bd-rd16" src="/assets/imgs/page/homepage10/img-tab.png" alt="DisputeDine" />
                            </div>
                ...
                <div className={activeIndex === 2 ? "tab-pane fade active show" : "tab-pane fade"}>
                    <div className="box-tab-32">
                        <div className="row align-items-center">
                            <div className="col-xl-6 col-lg-5">
                                <img className="bd-rd16" src="/assets/imgs/page/blog2/img1.png" alt="DisputeDine" />
                            </div>
                            <div className="col-xl-6 col-lg-7">
                                <div className="box-business-tab">
                                    <span className="btn btn-tag">Business</span>
